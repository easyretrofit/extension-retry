...
//                        Class<?>[] parameterTypes = blockMethod.getParameterTypes();
//                        int i = parameterTypes.length + 1;
//                        Class<?>[] parameterTypesAndEx = new Class[parameterTypes.length + 1];
//                        parameterTypesAndEx[i - 1] = RetrofitExtensionException.class;
//                        Method fallbackMethod;
//                        try {
//                            fallbackMethod = fallbackClazz.getDeclaredMethod(fallBackMethodName, parameterTypesAndEx);
//                            args = new Object[parameterTypes.length + 1];
//                            for (int j = 0; j < parameterTypes.length; j++) {
//                                args[j] = request.tag(parameterTypes[j]);
//                            }
//                            args[parameterTypes.length] = throwable;
//                            return fallbackMethod.invoke(fallBack, args);
//                        } catch (NoSuchMethodException e) {
//                            fallbackMethod = fallbackClazz.getDeclaredMethod(fallBackMethodName, blockMethod.getParameterTypes());
//                            return fallbackMethod.invoke(fallBack, args);
//                        }
//                    }
//                    return null;
